                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('admin.categories.reload') }}" class="btn btn-sm btn-default">{{ __('Reload By URL') }}</a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <form action="{{ route('admin.categories.destroy', $cate) }}" method="post">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('admin.categories.edit', $cate) }}">{{ __('Edit') }}</a>
