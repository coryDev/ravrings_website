@extends('layouts.admin.app', ['title' => __('User Management')])

@section('content')
    @include('layouts.admin.users.partials.header', ['title' => __('Edit User')])   
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('admin.users') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
