        ...
        <div class="position-relative">
            ...
            <section class="section section-lg section-shaped pb-250">
                ...
                <div class="container py-lg-md d-flex">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h1 class="display-3 text-white">Compare websites & shop</h1>
                            <p class="lead text-white">customer reviews & experience with. get friends advice - Ratings and purchase history with</p>
                            <div class="btn-wrapper">
                                <a href="" class="btn btn-info btn-icon mb-3 mb-sm-0">
                                <span class="btn-inner--text">Merchants</span>
                                </a>
                            ...
                            <div class="rounded shadow-lg overflow-hidden transform-perspective-right">
                              <div id="carousel_example2" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                  ...
                                  <li data-target="#carousel_example2" data-slide-to="1" class=""></li>
                                  <li data-target="#carousel_example2" data-slide-to="2" class=""></li>
                                  <li data-target="#carousel_example2" data-slide-to="3" class=""></li>
                                </ol>
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img class="img-fluid" src="{{ asset('img/theme/team-1-800x800.jpg') }}" alt="First slide">
                                  </div>
                                  <div class="carousel-item">
                                      <img class="img-fluid" src="{{ asset('img/theme/team-2-800x800.jpg') }}" alt="Middle slide">
                                    </div>
                                    <div class="carousel-item">
                                      <img class="img-fluid" src="{{ asset('img/theme/team-3-800x800.jpg') }}" alt="Middle slide">
                                    </div>
                                  <div class="carousel-item">
                                    <img class="img-fluid" src="{{ asset('img/theme/team-4-800x800.jpg') }}" alt="Second slide">
                                  </div>
                                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="row row-grid">
                    ...
                    <div class="card card-lift--hover shadow border-0">
                        ...
                        <h6 class="text-primary text-uppercase">Buy Products</h6>
                        <p class="description mt-3">It is a great free UI package based on Bootstrap 4 that includes the most important components and features.</p>
                        <div>
                    ...
                    <div class="card card-lift--hover shadow border-0">
                        ...
                        <h6 class="text-success text-uppercase">Sell Products</h6>
                        <p class="description mt-3">It is a great free UI package based on Bootstrap 4 that includes the most important components and features.</p>
                        <div>
                        ...
                        <a href="#" class="btn btn-success mt-4">More</a>
                        </div>
                    </div>
                    </div>
                    <div class="col-lg-4">
                    <div class="card card-lift--hover shadow border-0">
                        ...
                        <h6 class="text-warning text-uppercase">Reviews</h6>
                        <p class="description mt-3">It is a great free UI package based on Bootstrap 4 that includes the most important components and features.</p>
                        <div>
                        ...
                        <a href="#" class="btn btn-warning mt-4">More</a>
                        </div>
                    </div>
                    </div>
                </div>
        ...
        <section class="section section-lg">
            ...
            <div class="row row-grid align-items-center">
                ...
                <div class="pr-md-5">
                    ...
                    <p>It comes with three pre-built pages to help you get started faster. You can change the text and images and you're good to go.</p>
            ...
            <div class="container py-md">
              <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                  ...
                  <a href="" class="btn btn-white mt-4">See all components</a>
                </div>
                  ...
                  <div class="rounded shadow-lg overflow-hidden transform-perspective-right">
                    <div id="carousel_example" class="carousel slide" data-ride="carousel">
                      <ol class="carousel-indicators">
                        ...
                        <li data-target="#carousel_example" data-slide-to="3" class="active"></li>
                      </ol>
                      <div class="carousel-inner">
                        <div class="carousel-item">
                          <img class="img-fluid" src="{{ asset('img/theme/team-1-800x800.jpg') }}" alt="First slide">
            ...
            <div class="row">
                ...
                <div class="px-4">
                    ...
                    <h5 class="title">
                        ...
                        <small class="h6 text-muted">Director</small>
                    </h5>
                    <div class="mt-3">
        ...
        <section class="section section-lg pt-0">
            ...
            <div class="card bg-gradient-warning shadow-lg border-0">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                    <h3 class="text-white">We made your business building easier for you.</h3>
